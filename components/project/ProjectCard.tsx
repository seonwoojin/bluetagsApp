...
const ProjectWrapper = styled.View`
  ...
  max-width: 430px;
  min-width: 270px;
  width: ${Dimension.width < 500 ? `${Dimension.width * 0.9}px` : "430px"};
  height: 70px;
  margin-bottom: 10px;
  border-radius: 10px;
...
const ProjectLogo = styled.View`
  flex-direction: row;
  width: ${Dimension.width < 500 ? `${Dimension.width * 0.08}px` : "40px"};
  height: ${Dimension.width < 500 ? `${Dimension.width * 0.08}px` : "40px"};
  min-width: 25px;
  min-height: 25px;
...
const ProjectContent = styled.View`
  ...
  width: ${Dimension.width < 500
    ? `${Dimension.width * 0.9 - Dimension.width * 0.18 - 20}px`
    : "330px"};
  height: 39px;
  border-radius: 20px;
`;
...
const Button = styled.View`
  justify-content: center;
  align-items: center;
  width: ${Dimension.width < 400 ? `${Dimension.width * 0.1}px` : "40px"};
  height: ${Dimension.width < 400 ? `${Dimension.width * 0.1}px` : "40px"};
  background: #191f28;
  border-radius: 5px;
`;
