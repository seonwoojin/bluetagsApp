...
export default function Detail({ detail, setDetail }: Props) {
  ...
  const handleBackPress = () => {
    if (index === 0) {
      moveRight();
      setTimeout(() => setDetail((prev) => !prev), 150);
    } else {
      setIndex(0);
    }
      ...
      >
          ...
          <>
            ...
            >
              <UserDetail>
                ...
                <UserDetailText>Info</UserDetailText>
              </UserDetail>
            </TouchableHighlight>
            <TouchableHighlight
              underlayColor={"rgba(121, 183, 255, 0.3)"}
        ...
        {index === 1 ? (
          <>
                  ...
                  [
                    {
                      ...
                      onPress: () => {
                        axios
                          .post(
                            "https://www.bluetags.app/api/users/edit/delete",
                            { id: user.id }
                          )
                          .then(async () => {
                            setDetail(false);
            ...
            >
              <UserDetail>
                <UserDetailText>회원 탈퇴</UserDetailText>
              </UserDetail>
            </TouchableHighlight>
          </>
        ) : null}
        {index === 2 ? (
          <>
            <UserDetail>
              <A href="https://www.about.bluetags.app/legal/%EA%B0%9C%EC%9D%B8%EC%A0%95%EB%B3%B4%EC%B2%98%EB%A6%AC%EB%B0%A9%EC%B9%A8">
                <UserDetailText>개인정보처리방침</UserDetailText>
              </A>
            </UserDetail>
            <UserDetail>
              <A href="https://www.about.bluetags.app/legal/%EC%84%9C%EB%B9%84%EC%8A%A4-%EC%9D%B4%EC%9A%A9%EC%95%BD%EA%B4%80">
                <UserDetailText>서비스 이용약관</UserDetailText>
              </A>
            </UserDetail>
            <UserDetail>
              <A href="https://www.about.bluetags.app/legal/terms-of-use">
                <UserDetailText>Terms of use</UserDetailText>
              </A>
            </UserDetail>
            <UserDetail>
              <A href="https://www.about.bluetags.app/legal/privacy-policy">
                <UserDetailText>Privacy policy</UserDetailText>
              </A>
            </UserDetail>
          </>
        ) : null}
